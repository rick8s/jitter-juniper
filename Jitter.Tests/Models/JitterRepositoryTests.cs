...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        [TestMethod]
        public void JitterrepositoryTestsEnsureICanSearchByName()
        {
            // Arrange
            var expected = new List<JitterUser>
            {
                ...
                new JitterUser { Handle = "treehugger", FirstName = "Popeye", LastName = "Sailor" },
        ...
        [TestMethod]
        public void JitterRepositoryEnsureeICanGetAllJots()
        {
            ...
            Assert.AreEqual("Hello World!", actual_jots[0].Content);// Just to check our sort
        }
